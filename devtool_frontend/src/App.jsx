...
import Ongoing_v from './screen/Activity_ongoing'
import Charity_com from './screen/Charity_com'
function App() {
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path='/Ongoing' element={<Ongoing_v/>}/>
        <Route path='/Ongoing_Charity' element={<Ongoing/>}/>
        <Route path='/Create' element={<Create_Activity/>}/>
        <Route path='/Activity_complete' element={<Complete/>}/>
        <Route path='/Charity_complete' element={<Charity_com/>}/>
