...
function Charity_com() {
  ...
  useEffect(() => {
    ...
    axios
      .post(`${path}/charity_completed`, { u_id: localStorage.getItem("user") })
      .then((response) => {
  ...
  return (
    <div className="pb-10">
      ...
      <div className="py-2 bg-[#FD7D61]">
        <div>
          <p className="text-3xl text-white font-bold text-center">Activity Completed</p>
        </div>
      </div>
      <div>
        {myActivity && (
